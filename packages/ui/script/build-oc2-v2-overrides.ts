...
const themePath = path.join(import.meta.dirname, "..", "src", "theme", "themes", "oc-2.json")
const theme = JSON.parse(readFileSync(themePath, "utf8")) as DesktopTheme
const css = readFileSync(path.join(import.meta.dirname, "..", "src", "v2", "styles", "theme.css"), "utf8")
...
writeFileSync(themePath, JSON.stringify(next, null, 2) + "\n")
