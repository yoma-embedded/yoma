...
const icons = {
  ...
  clock: {
    viewBox: "0 0 16 16",
    body: `<path d="M8 4.5V8L10.5 9.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M14 8C14 11.3137 11.3137 14 8 14C4.68629 14 2 11.3137 2 8C2 4.68629 4.68629 2 8 2C11.3137 2 14 4.68629 14 8Z" stroke="currentColor"/>`,
  },
  at: {
    viewBox: "0 0 16 16",
    body: `<path d="M10.5 8C10.5 9.38071 9.38071 10.5 8 10.5C6.61929 10.5 5.5 9.38071 5.5 8C5.5 6.61929 6.61929 5.5 8 5.5C9.38071 5.5 10.5 6.61929 10.5 8ZM10.5 8V9.25C10.5 10.0784 11.1716 10.75 12 10.75C12.8284 10.75 13.5 10.0784 13.5 9.25V8C13.5 4.96243 11.0376 2.5 8 2.5C4.96243 2.5 2.5 4.96243 2.5 8C2.5 11.0376 4.96243 13.5 8 13.5C9.19318 13.5 10.2988 13.1199 11.2015 12.474" stroke="currentColor"/>`,
  },
  "chevron-right": {
    viewBox: "0 0 16 16",
    body: `<path d="M6.5 5L9.5 8L6.5 11" stroke="currentColor"/>`,
  },
  sidebar: {
    viewBox: "0 0 16 16",
    body: `<rect x="2" y="3.5" width="12" height="9" rx="1.5" stroke="currentColor"/><path d="M6.5 3.5V12.5" stroke="currentColor"/>`,
  },
  "expand-corners": {
    viewBox: "0 0 16 16",
  ...
  "square-plus": {
    viewBox: "0 0 16 16",
    body: `<rect x="2.5" y="2.5" width="11" height="11" rx="2.5" stroke="currentColor"/><path d="M8 5.75V10.25M5.75 8H10.25" stroke="currentColor" stroke-linecap="round"/>`,
  },
  folder: {
    viewBox: "0 0 16 16",
    body: `<path d="M2 4.5C2 3.94772 2.44772 3.5 3 3.5H5.79289C5.92548 3.5 6.05266 3.55268 6.14645 3.64645L7.35355 4.85355C7.44732 4.94732 7.57452 5 7.70711 5H13C13.5523 5 14 5.44772 14 6V12C14 12.5523 13.5523 13 13 13H3C2.44772 13 2 12.5523 2 12V4.5Z" stroke="currentColor" stroke-linejoin="round"/>`,
  },
}
