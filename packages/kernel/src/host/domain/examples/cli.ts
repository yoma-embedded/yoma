 ...
 *
 *   tsx packages/kernel/src/host/domain/examples/cli.ts index  --ecosystem esp-idf|stm32cube --root <目录> [--corpus <id>] [--config-dir <目录>]
 *   tsx packages/kernel/src/host/domain/examples/cli.ts index  --ecosystem generic --root <目录> --corpus <id> --proposal <file> [--tier seed|lib] [--indexer provided|agent]
 *   tsx packages/kernel/src/host/domain/examples/cli.ts enrich [--corpus <id>]... [--model <provider/model>] [--concurrency <n>] [--limit <n>]
 *   tsx packages/kernel/src/host/domain/examples/cli.ts sync   [--server <url>] [--config-dir <目录>]        # 远端清单 × 本地状态
 *   tsx packages/kernel/src/host/domain/examples/cli.ts sync   <语料id>... [--server <url>] [--code] [--config-dir <目录>]
 *   tsx packages/kernel/src/host/domain/examples/cli.ts search [--ecosystem <e>] [--target <t>] [--board <b>] [--peripheral <p> ...] [--keyword <k> ...] [--buildable] [--tier <t>] [--kind <k> ...] [--corpus <id> ...] [--json] [--limit <n>]
 *   tsx packages/kernel/src/host/domain/examples/cli.ts show   <条目 id>
 *   tsx packages/kernel/src/host/domain/examples/cli.ts preflight <底盘id> <供体id>...
 *   tsx packages/kernel/src/host/domain/examples/cli.ts list
 */
