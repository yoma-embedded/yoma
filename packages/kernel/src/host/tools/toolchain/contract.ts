...
- Per tool, optional: "version" (">=3.22", "^13.2", "12"), "optional":true, "env" (variable names that may point at it), "versionArgs" (when the tool does not answer --version, e.g. ["version"]), "install" (per-platform hint), "why".
