...
const IconButtonV2 = lazy(() =>
  import("@yoma-desktop/ui/v2/icon-button-v2").then((module) => ({ default: module.IconButtonV2 })),
)
const TextInputV2 = lazy(() =>
  import("@yoma-desktop/ui/v2/text-input-v2").then((module) => ({ default: module.TextInputV2 })),
)
