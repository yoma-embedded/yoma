...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Yoma zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Yoma zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Yoma zu nutzen.",
  ...
  "dialog.plugins.empty": "In ~/.my-pi/auth.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Yoma-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Yoma ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Yoma-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (~/.my-pi/auth.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Yoma unterstützt noch keine MCP-Authentifizierung.',
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Yoma ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Yoma auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Yoma dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Yoma anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Yoma automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Yoma.",
