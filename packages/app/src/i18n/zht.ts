...
export const dict = {
  ...
  "codex.scheduled": "已排程",
  "codex.plugins": "外掛",
  "codex.conversations": "對話",
  "codex.noConversations": "尚無對話",
  "codex.upgrade": "升級",
  "codex.plan.free": "Free",
  "codex.comingSoon": "即將推出",
  "codex.search.placeholder": "搜尋聊天或執行命令",
  "codex.search.chats": "聊天",
  "codex.search.suggested": "推薦",
  "codex.search.openFolder": "開啟資料夾",
  "codex.search.searchFiles": "搜尋檔案",
  "codex.search.newQuickChat": "新建快速對話",
  "codex.search.openNewWindow": "在新視窗中開啟",
  "codex.search.archiveChat": "封存聊天",
  "codex.search.togglePin": "切換置頂狀態",
  "codex.search.noResults": "找不到聊天",
  "codex.collapseSidebar": "收合側欄",
  "codex.expandSidebar": "顯示側欄",
  "codex.projects.expand": "展開",
  "codex.projects.more": "更多",
  "codex.projects.new": "新增項目",
  "codex.projects.newDesc": "開啟現有資料夾，或新建一個",
  "codex.projects.browse": "瀏覽…",
  "codex.projects.openExisting": "開啟現有資料夾",
  "codex.projects.openExistingDesc": "將現有資料夾加入為專案",
  "codex.projects.newFolder": "新增資料夾",
  "codex.projects.newFolderDesc": "建立新資料夾並作為專案開啟",
  "codex.projects.location": "位置",
  "codex.projects.chooseLocation": "選擇位置",
  "codex.projects.folderName": "資料夾名稱",
  "codex.projects.create": "建立",
  "codex.projects.createFolderError": "無法建立資料夾",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Yoma 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Yoma 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Yoma 中使用 {{provider}} 模型。",
  ...
  "prompt.example.1": "把這份 ELF 燒上去，確認晶片在跑",
  "prompt.example.2": "讀串列日誌，解釋這次復位",
  "prompt.example.3": "掛上 gdb，把 HardFault 呼叫堆疊打出來",
  "prompt.example.4": "原理圖上這個腳接的是什麼？",
  "prompt.example.5": "查參考手冊裡 ADC 的取樣時間",
  "prompt.example.6": "給這塊板產生 STM32 時鐘和 GPIO 初始化",
  "prompt.example.7": "probe-rs 為什麼連不上目標？",
  "prompt.example.8": "盯這個變數，看 RTOS 還活不活",
  "prompt.example.9": "把片上 flash 和這份韌體比對一下",
  "prompt.example.10": "幫我在工位上把這個 bug 重現出來",
  "prompt.example.11": "在除錯串列上開始採 log",
  "prompt.example.12": "這個 HardFault 狀態暫存器是什麼意思？",
  "prompt.example.13": "燒完之後把這些 RAM 位址 dump 出來",
  "prompt.example.14": "從 RAM 讀建構指紋，確認是新映像",
  "prompt.example.15": "列出這條 I2C 匯流排上的裝置",
  "prompt.example.16": "這個 GPIO 為什麼不翻轉？",
  "prompt.example.17": "講一下這顆 STM32 的時鐘樹",
  "prompt.example.18": "板子列舉一下就消失了，該查什麼？",
  "prompt.example.19": "停核，把堆疊 dump 出來",
  "prompt.example.20": "除錯口接到哪路 UART？",
  "prompt.example.21": "是不是看門狗在復位？",
  "prompt.example.22": "這次燒完，證明跑的是新映像",
  "prompt.example.23": "工位機需要裝哪些工具鏈？",
  "prompt.example.24": "給工位機打一份診斷腳本",
  "prompt.example.25": "兩台機器的信箱要怎麼配？",
  ...
  "dialog.plugins.empty": "在 ~/.my-pi/auth.json 中設定的外掛程式",
  ...
  "dialog.server.description": "不用管。這個應用連的是本機核心，沒有遠端伺服器可切換。",
  ...
  "toast.update.description": "Yoma 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Yoma 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (~/.my-pi/auth.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Yoma 暫不支援 MCP 認證。',
  ...
  "explorer.openFile": "開啟檔案",
  "explorer.newFile": "新增檔案",
  "explorer.newFile.desc": "在工作區內建立一個空檔案",
  "explorer.newFile.placeholder": "相對路徑，例如 src/main.c",
  "explorer.newFile.create": "建立",
  "explorer.newFile.exists": "該路徑已存在同名檔案",
  "explorer.newFile.invalid": "檔案路徑不合法",
  "explorer.newFile.createError": "建立檔案失敗",
  "explorer.addToChat": "加入對話",
  "explorer.preview": "預覽",
  "explorer.markdown": "Markdown",
  "explorer.save": "儲存",
  "explorer.saveError.title": "儲存失敗",
  "explorer.saveUnsupported": "儲存檔案需要桌面版應用",
  "explorer.toggleTree": "顯示/隱藏檔案樹",
  "explorer.search": "搜尋檔案",
  "explorer.back": "上一步",
  "explorer.forward": "下一步",
  "explorer.revealInTree": "在檔案樹中定位",
  "explorer.copyPath": "複製路徑",
  "explorer.copyRelativePath": "複製相對路徑",
  "explorer.reload": "重新從磁碟載入",
  "explorer.diskChanged": "磁碟上的檔案已變更",
  "explorer.diskChanged.reload": "重新載入",
  "explorer.diskChanged.keep": "保留我的編輯",
  "explorer.readonly.large": "檔案過大，無法編輯——已切換為唯讀預覽",
  ...
  "terminal.list": "終端機列表",
  "terminal.count.one": "{{count}} 個終端機",
  "terminal.count.other": "{{count}} 個終端機",
  "terminal.openInBottomPanel": "終端機已在底部面板打開",
  "terminal.moveHere": "移回此處",
  ...
  "sidebar.gettingStarted.line1": "Yoma 沒有內建免費模型。在設定裡填 DeepSeek 或 Kimi 的 API key 才能開始。",
  "sidebar.gettingStarted.line2": "目前只接了 DeepSeek 和 Kimi，不是任意雲端廠商都能連。",
  ...
  "settings.general.row.language.description": "變更 Yoma 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Yoma 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Yoma 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Yoma 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Yoma 啟動時自動檢查更新",
