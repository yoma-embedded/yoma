export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Yoma.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Yoma.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Yoma.",
  ...
  "dialog.plugins.empty": "Plugins configurados em ~/.my-pi/auth.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Yoma este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Yoma ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Yoma",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (~/.my-pi/auth.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Yoma ainda não suporta autenticação MCP.',
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Yoma",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Yoma aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Yoma segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Yoma é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Yoma iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Yoma.",
