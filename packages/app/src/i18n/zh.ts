...
export const dict = {
  ...
  "command.terminal.toggle": "切换终端（未实现）",
  ...
  "command.terminal.new.description": "未实现 — Yoma 没有应用内终端",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Yoma 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Yoma 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Yoma 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "这个应用没有插件配置",
  ...
  "dialog.server.description": "不用管。这个应用连的是本机内核，没有远程服务器可切换。",
  ...
  "dialog.server.default.description": "不用管。这个应用只用本机内核。",
  ...
  "error.page.report.prefix": "这是 Yoma 的错误，不是 OpenCode。",
  ...
  "settings.general.row.terminalFont.description": "未使用。Yoma 没有应用内终端。",
