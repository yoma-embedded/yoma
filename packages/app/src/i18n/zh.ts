...
export const dict = {
  ...
  "bench.kind.runner": "工位",
  "bench.kind.mother": "决策",
  "bench.kind.sim": "本机演练",
  "bench.kind.init": "入箱",
  "bench.config.remote": "信箱远端(git)",
  "bench.config.remote.hint": "任何两台机器都能读写的 git 远端。凭据走系统 git,应用不保存。",
  "bench.config.role": "本机角色",
  "bench.config.role.runner": "工位(连着板子,跑调试 agent)",
  "bench.config.role.mother": "决策(跑母 agent)",
  ...
  "bench.from.mother": "来自母 agent",
  "bench.decision.mother": "母 agent",
  ...
  "bench.progress.state.awaitingRunner": "等工位执行",
  "bench.progress.state.awaitingMother": "等母 agent 裁决",
