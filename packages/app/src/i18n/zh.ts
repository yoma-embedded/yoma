...
export const dict = {
  ...
  "bench.config.projectDir": "工程目录(本机)",
  "bench.config.projectDir.hint": "这台机器上工程的检出路径。信箱里的任务书不带绝对路径 —— 它在别人机器上没意义,所以两侧各配各的。",
  ...
  "bench.task.template.hint": "带着项目判据与硬件事实的任务书骨架。判据永远来自模板,不由描述生成。",
  "bench.task.description": "要修什么",
  "bench.task.description.placeholder": "描述这个 bug:现象、怎么复现、什么样算修好…",
  "bench.task.tier": "预算档",
  "bench.task.tier.quick": "快速(4 轮 / 30 万 tokens / 45 分钟)",
  "bench.task.tier.standard": "标准(8 轮 / 100 万 tokens / 2 小时)",
  "bench.task.tier.thorough": "彻底(12 轮 / 250 万 tokens / 6 小时)",
  ...
  "bench.task.needConfig": "先在配置页填好信箱远端、本机角色与工程目录并保存。",
  ...
  "bench.decision.policy": "确定性守卫",
  "bench.decision.continue": "继续",
  "bench.decision.success": "成功",
  "bench.decision.fail": "失败",
  "bench.decision.park": "挂起",
  ...
  "bench.progress.denied": "被拦",
  "bench.progress.artifacts": "附件:",
  "bench.progress.incoming": "附件已落到:",
  "bench.progress.dirty": "工位端改了工作树 —— 它不该改代码,这轮证据要打折",
