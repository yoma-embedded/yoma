export const dict = {
  ...
  "session.review.noUncommittedChanges": "暂无未提交的改动",
  "session.review.noCommits": "仓库还没有提交。做一次初始提交后，这里会显示相对上次提交的改动。",
  ...
  "sidebar.gettingStarted.line1": "Yoma 没有内置免费模型。在设置里填一家模型厂商的 API key 才能开始（DeepSeek、Kimi、OpenAI、Anthropic、Google、OpenRouter 等）。",
  "sidebar.gettingStarted.line2": "凡是一个 API key 就能用的厂商都能连；要额外填账号 ID、区域或项目的（如 Bedrock、Vertex、Cloudflare）暂不提供。",
  ...
  "settings.toolchain.machine.summary": "已就绪 {{ok}} / {{total}}",
  ...
  "session.review.noVcs.createGit.failed": "创建 Git 仓库失败",
