...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Yoma'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Yoma'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Yoma'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler ~/.my-pi/auth.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Yoma sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Yoma'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Yoma ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (~/.my-pi/auth.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Yoma henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "settings.general.row.language.description": "Yoma'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Yoma'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Yoma'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Yoma'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Yoma başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Yoma'un en son sürümünü kullanıyorsunuz.",
