export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Yoma-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Yoma-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Yoma-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u ~/.my-pi/auth.json",
  ...
  "dialog.server.description": "Promijeni na koji se Yoma server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Yoma-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Yoma timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (~/.my-pi/auth.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Yoma još ne podržava MCP autentifikaciju.',
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Yoma-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Yoma izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Yoma prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Yoma-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Yoma pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Yoma-a.",
