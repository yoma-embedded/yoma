export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Yoma.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Yoma.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Yoma.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans ~/.my-pi/auth.json",
  ...
  "dialog.server.description": "Changez le serveur Yoma auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Yoma ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Yoma",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (~/.my-pi/auth.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Yoma ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Yoma has no bundled models. Add a DeepSeek or Kimi API key in Settings to start.",
  "sidebar.gettingStarted.line2":
    "Connect DeepSeek or Kimi. Other providers are not wired up in this app.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Yoma",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Yoma sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Yoma suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Yoma.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Yoma",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Yoma.",
