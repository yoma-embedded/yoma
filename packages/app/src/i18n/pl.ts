export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Yoma.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Yoma.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Yoma.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w ~/.my-pi/auth.json",
  ...
  "dialog.server.description": "Przełącz serwer Yoma, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Yoma ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Yoma",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (~/.my-pi/auth.json) nazwy dostawców/modeli",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Yoma",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Yoma na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Yoma ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Yoma.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Yoma",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Yoma.",
