export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Yoma.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Yoma.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Yoma.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i ~/.my-pi/auth.json",
  ...
  "dialog.server.description": "Skift hvilken Yoma-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Yoma ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Yoma-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (~/.my-pi/auth.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Yoma understøtter ikke MCP-godkendelse endnu.',
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Yoma",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Yoma ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Yoma følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Yoma er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Yoma starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Yoma.",
