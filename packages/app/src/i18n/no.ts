...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Yoma.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Yoma.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Yoma.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i ~/.my-pi/auth.json",
  ...
  "dialog.server.description": "Bytt hvilken Yoma-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Yoma ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Yoma-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (~/.my-pi/auth.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Yoma ikke støtter MCP-autentisering ennå.',
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Yoma",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Yoma ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Yoma skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Yoma er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Yoma starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Yoma.",
