export const dict = {
  ...
  "bench.config.projectDir": "Project directory (this machine)",
  "bench.config.projectDir.hint": "Where this machine has the project checked out. The job in the mailbox carries no absolute paths — they mean nothing on the other machine — so each side configures its own.",
  ...
  "bench.task.template.hint": "A job skeleton with the project's checks and hardware facts. Checks always come from the template — never generated from the description.",
  ...
  "bench.task.tier": "Budget",
  "bench.task.tier.quick": "Quick (4 rounds / 300k tokens / 45 min)",
  "bench.task.tier.standard": "Standard (8 rounds / 1M tokens / 2 h)",
  "bench.task.tier.thorough": "Thorough (12 rounds / 2.5M tokens / 6 h)",
  ...
  "bench.task.needConfig": "Set the mailbox remote, this machine's role and its project directory first (Setup tab).",
  ...
  "bench.decision.policy": "Deterministic guard",
  "bench.decision.continue": "continue",
  "bench.decision.success": "success",
  "bench.decision.fail": "fail",
  "bench.decision.park": "park",
  ...
  "bench.progress.denied": "denied",
  "bench.progress.artifacts": "Attachments: ",
  "bench.progress.incoming": "Landed at: ",
  "bench.progress.dirty": "The station changed the working tree — it must not edit code, so this round's evidence is weaker",
