export const dict = {
  ...
  "settings.license.state.not-required": "No license check",
  ...
  "settings.license.stateDetail.not-required": "Community / development build: this build does not check licenses, so the full feature set is already open.",
  "settings.license.stateDetail.missing": "No license file has been imported yet. The official commercial build needs a valid license to start a run; past sessions, settings, files and the waveform panels stay available.",
