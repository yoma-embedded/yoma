export const dict = {
  ...
  "bench.config.role.runner": "Station (board attached, runs the agent)",
  "bench.config.role.mother": "Decision (runs the mother agent)",
  ...
  "bench.from.mother": "from mother agent",
  "bench.decision.mother": "Mother agent",
  ...
  "bench.progress.state.awaitingMother": "Waiting for the mother agent to decide",
