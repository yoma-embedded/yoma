export const dict = {
  ...
  "sidebar.gettingStarted.line1": "Yoma has no bundled models. Add a provider API key in Settings to start (DeepSeek, Kimi, OpenAI, Anthropic, Google, OpenRouter, …).",
  "sidebar.gettingStarted.line2": "Any provider that works with a single API key can be connected. Providers that need extra setup (account id, region, project — e.g. Bedrock, Vertex, Cloudflare) are not offered.",
  ...
  "settings.toolchain.status.ok": "Ready",
