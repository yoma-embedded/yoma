...
From the repo root: `npm run dev:desktop`. Renderer has HMR; **the kernel process does not** — kernel changes (`packages/kernel`, including `src/host`) need a restart of that command.
