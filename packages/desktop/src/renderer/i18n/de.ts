export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Yoma",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Yoma wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
