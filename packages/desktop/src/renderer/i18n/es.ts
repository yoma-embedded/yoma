export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Yoma",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Yoma. ¿Quieres instalarla y reiniciar?",
