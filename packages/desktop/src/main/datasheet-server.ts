/**
 * 数据手册服务器地址:解析规则只有一份 —— kernel 的 `src/host/datasheet-server.ts`
 ...
 *
 * 2026-09-05 起有内置默认(见 kernel 那份文件头的产品决定),从前"没有内置主机"
 * 的说法作废。
 */
import { DATASHEET_SERVER_ENV, resolveDatasheetServer } from "@yoma-desktop/kernel/host/datasheet-server"
